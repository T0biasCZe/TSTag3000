        ...
        private class FontMetricsImpl : FontMetrics
        {
                ...
                Font font)
            {
                ...
                try
                {
                    hDC = graphics.GetHdc();
                    hFont = font.ToHfont();
                    nint hFontDefault = SelectObject(hDC, hFont);
                    bool result = GetTextMetrics(hDC, out textMetric);
                    SelectObject(hDC, hFontDefault);
                }
                finally
                {
                    if (hFont != nint.Zero) DeleteObject(hFont);
                    if (hDC != nint.Zero) graphics.ReleaseHdc(hDC);
                }
                return textMetric;
            }
            private TEXTMETRIC metrics;
            public override int Height { get { return metrics.tmHeight; } }
            public override int Ascent { get { return metrics.tmAscent; } }
            public override int Descent { get { return metrics.tmDescent; } }
            public override int InternalLeading { get { return metrics.tmInternalLeading; } }
            public override int ExternalLeading { get { return metrics.tmExternalLeading; } }
            public override int AverageCharacterWidth { get { return metrics.tmAveCharWidth; } }
            public override int MaximumCharacterWidth { get { return metrics.tmMaxCharWidth; } }
            public override int Weight { get { return metrics.tmWeight; } }
            public override int Overhang { get { return metrics.tmOverhang; } }
            public override int DigitizedAspectX { get { return metrics.tmDigitizedAspectX; } }
            public override int DigitizedAspectY { get { return metrics.tmDigitizedAspectY; } }
